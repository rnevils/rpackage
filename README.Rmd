...
Use `make_top_title_word_cloud()` to make a word cloud of 200 of the titles on YouTube's most popular videos. In addition to an API key, this function allows you to input custom parameters for the size, color and shape of the title word cloud. 
